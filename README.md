# SDB_1
# Домашнее задание к занятию «Базы данных, их типы» студента Киямова Максима.
...
SQL-системы используют унифицированный язык запросов, который обеспечивает простоту и гибкость в создании запросов.
Весьма распространены и имеют широкубю подержку разрботчиков.
Хорошо интегрируются с различными инструментами для бизнес-аналитики
У SQL-систем есть множество инструментов для управления и администрирования баз данных.
